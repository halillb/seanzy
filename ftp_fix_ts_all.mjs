...
const LOCAL  = String.raw`C:\Users\halil\OneDrive\Masaüstü\PROJELER\estetix\SÜRÜMLER\fix_ts_all.php`
const REMOTE = '/public_html/homedya.com/estetix/fix_ts_all.php'
const URL    = 'https://homedya.com/estetix/fix_ts_all.php?key=EstetiX2026migrate'
