...
const LOCAL  = String.raw`C:\Users\halil\OneDrive\Masaüstü\PROJELER\estetix\SÜRÜMLER\chk_path.php`
const REMOTE = '/public_html/homedya.com/estetix/chk_path.php'
const URL    = 'https://homedya.com/estetix/chk_path.php?key=EstetiX2026migrate'
